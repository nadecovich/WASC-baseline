...
load("V:/Analysis/3_AYK/Chum/WASC/WASCbaselineData")
##save.image("V:/Analysis/3_AYK/Chum/WASC/WASCbaselineData")
#Set the working directory
setwd("V:/Analysis/3_AYK/Chum/WASC")
...
#Get locus list from the 2014 Chinook baseline
species <- "chum"
...
FreqFisPlot4SNPs.GCL(sillyvec=SillysPooled, loci=loci, groupvec=GroupVec32, alpha=0.05,groupcol=NULL,file="V:/Analysis/3_AYK/Chum/WASC/Output/WASCpopfreq.pdf")
